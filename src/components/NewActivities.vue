...
<template>
  ...
  >
    <div class="flex h-full items-center">
      <div
        class="ml-3 flex h-[50px] w-[120px] shrink-0 md:w-[150px] items-center justify-center  text-[14px] sm:h-[75px] sm:text-[18px] md:text-xl lg:mr-6 lg:text-2xl xl:text-2xl"
         :class="[cardStyle.bg, cardStyle.text]"
      >
        {{ cardStyle.label }}
      </div>
      <div
        class="mr-3 w-[90px] border-r-2 border-gray-700 px-4 md:w-[120px] lg:mr-6 lg:w-[150px]"
      >
